    ...
    public void run() { 
        try {
            ...
            while (true) {
                ...
                EventBus.announce(EventBus.EV_SHOW, "7) Check student course conflict");
                ...
                if (sChoice.equals("6")) {
                    ...
                    /*
                    Part c
                    input the student ID , course ID and  course section to check whether the student has the course conflict.
                    if the student has course conflict, it will pop out ------Registration conflicts------
                     */
                if (sChoice.equals("7")) {
                    // Get student ID, course ID, and course section from user.
                    EventBus.announce(EventBus.EV_SHOW, "\nEnter student ID and press return >> ");
                    ...
                    EventBus.announce(EventBus.EV_SHOW, "\n");
                    EventBus.announce(EventBus.EV_Check_CourseConflict, sSID + " " + sCID + " " + sSection);
                    continue;
                }
